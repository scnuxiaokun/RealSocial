...
-(NSData *)mokeResponse {
    ...
    ChatItem *info2 = [ChatItem new];
    info2.name = @"kuncai test";
    info2.iconURL = @"https://gss3.bdstatic.com/7Po3dSag_xI4khGkpoWK1HF6hhy/baike/w%3D268%3Bg%3D0/sign=318b6bf6073387449cc5287a6934bec4/d53f8794a4c27d1e15b40e6210d5ad6edcc43881.jpg";
    info2.text = @"say somethine";
    list.listArray = @[info, info2];
    return [list data];
}
@end
