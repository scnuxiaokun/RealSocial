...
@interface RSCameraViewController () <DBCameraManagerDelegate, DBCameraViewDelegate> {
...
- (void) viewDidLoad
{
    ...
    NSError *error;
    if ( [self.cameraManager setupSessionWithPreset:AVCaptureSessionPresetPhoto backCamera:self.isDefaultBackCamera error:&error] ) {
