 ...
 */
@interface RSCameraViewController : RSSubUIViewController <DBCameraSegueSettings, DBCameraViewControllerSettings>
/**
...
@property (nonatomic, assign) BOOL isDefaultBackCamera;
