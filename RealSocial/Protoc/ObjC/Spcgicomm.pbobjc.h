...
@interface BaseReq : GPBMessage

@end

#pragma mark - BaseResp

typedef GPB_ENUM(BaseResp_FieldNumber) {
  BaseResp_FieldNumber_ErrCode = 1,
  BaseResp_FieldNumber_ErrMsg = 2,
};

@interface BaseResp : GPBMessage
